...
interface ActivityProps {
  ...
  activityData: any; // Define the type of activityData as needed
...
export default function ActivityTable({
  ...
  const [editedCards, setEditedCards] = useState<any[]>(); // Define the type as needed
  ...
  if ((isFetchingEditedCards && !editedCards) || isFetchingActivityData) {
    return null; // Return nothing or your custom loading indicator
  }
  return (
    <Styles>
